  ...
  const inputElement = (
    <View className="relative w-full flex-row items-center">
      <TextInput
        ...
        className={cn(
          "bg-card border border-border text-foreground flex h-12 w-full min-w-0 flex-row items-center rounded-2xl px-4 text-sm font-medium shadow-2xs",
          ...
          Platform.select({
            web: cn(
              "placeholder:text-muted-foreground selection:bg-purple-500 selection:text-white outline-none transition-[color,box-shadow]",
